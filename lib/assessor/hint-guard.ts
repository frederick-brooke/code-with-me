 ...
 * hosted prompt can leak an implementation. The Candidate's question is never
 * used to shape the response — a Learner cannot coerce an escalation the
 * durable counter has not earned. The response never carries hidden test
 * inputs, expected outputs, or any problem internals beyond the guidance.
 */
